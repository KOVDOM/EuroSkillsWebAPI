...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Ápr 19. 18:12
...
--
ALTER TABLE `versenyzo`
  ADD CONSTRAINT `versenyzo_ibfk_1` FOREIGN KEY (`orszagid`) REFERENCES `orszag` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `versenyzo_ibfk_2` FOREIGN KEY (`szakmaid`) REFERENCES `szakma` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
